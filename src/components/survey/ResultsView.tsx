...
const ResultsView = ({
  ...
  // Feature flag: set to true to re-enable detailed results display
  const SHOW_DETAILED_RESULTS = false;
  ...
  return (
    <div className="w-full max-w-3xl mx-auto">
      ...
      {/* ── Detailed Results (hidden via feature flag) ────────────────── */}
      ...
      {/* ── Thank You Message (shown when detailed results are hidden) ── */}
      {!SHOW_DETAILED_RESULTS && (
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          >
            We appreciate you completing the survey. We will review your responses and get back to you.
          </motion.p>
        </motion.div>
      )}
